...
module.exports = Series = (function(_super) {
  ...
  Series.aggregation = function(calc) {
    ...
    sort = null;
    aggr = function() {
      var aggregated, args, data, i, k, keyvals, len, obj, values, _i, _ref;
...
(function(Series) {
  var day, dayOfYear, formatPad, formats, hour, minute, month, normal, offset, pads, week, year;
  ...
  normal = function(msec) {
    ...
    return function(time) {
      ...
      return new Date((0 | time * imsec) * msec);
    };
  };
  minute = normal(60000);
  hour = normal(3600000);
